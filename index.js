...
function setToArray(mySet) {
  ...
  const arrFilter = arr.filter((elem) => typeof elem === "string");
...
function sumNumbers(set) {
  ...
  const forEach = set.forEach((elem) => {
